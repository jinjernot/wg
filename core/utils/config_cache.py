...
def get_cached_payment_account(json_filename):
    ...
    with _payment_data_lock:
        ...
        # Load from disk (inside the lock to prevent thundering-herd on cache miss)
